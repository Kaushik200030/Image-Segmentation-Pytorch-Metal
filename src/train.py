...
if __name__ == "__main__":
    ...
    #To check whether the model is trained partially(if yes then it will get the semi- trained model and strat from that)
    ...
    try:
        ...
        print(f'Batch size pased {batch_size}')
    ...
    try:
        ...
        print(f"Training is starting from {start_epoch} epochs")

    except Exception as e:
        logger.error("Failed to load the latest checkpoint!")
        raise e
    ...
    try:
        ...
        for i in range(start_epoch, epochs):
            ...
            if max_score < valid_logs['iou_score']:
                ...
                }, os.path.join(checkpoint_dir, f'checkpoint_epoch_{i}.pth'))
